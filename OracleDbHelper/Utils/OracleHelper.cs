...
namespace OracleDbHelper.Utils
{
    public static class OracleHelper
    {
        ...
        public static OracleConnection OpenConn()
        {
            ...
            conn.ConnectionString = "Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=192.168.57.9)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=mstr9)));Persist Security Info=True;User ID=lmis;Password=lmis6tsl;"; //
            conn.Open();
            return conn;
        }
